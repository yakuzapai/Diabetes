...
import com.kandon.caramelwaffle.diabetes.Adapter.FruitAdapter;
...
public class FruitFragment extends Fragment {
    ...
    private void setInstances(View rootView, Bundle savedInstanceState) {
        ...
        mFoodRef = mDatabase.child("fruit");
        adapter = new FruitAdapter(context,mFoodRef);
        fruitRecyclerView.addItemDecoration(new DividerItemDecoration(context, DividerItemDecoration.HORIZONTAL));
        fruitRecyclerView.setLayoutManager(new LinearLayoutManager(context));
