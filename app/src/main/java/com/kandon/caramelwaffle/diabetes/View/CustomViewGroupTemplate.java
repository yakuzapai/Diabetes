package com.kandon.caramelwaffle.diabetes.View;
...
import com.kandon.caramelwaffle.diabetes.View.state.BundleSavedState;
...
public class CustomViewGroupTemplate extends BaseCustomViewGroup {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.fragment_main, this);
    }
